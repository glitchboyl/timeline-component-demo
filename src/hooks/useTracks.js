...
const useTracks = () => {
  ...
  const getTrackIndex = (trackId) =>
    trackId === "main" ? 0 : Number(trackId) + 1;
      ...
      if (type === "INSERT_TRACK") {
        ...
        if (!isNaN(insertIndex)) {
          if (typeof clip.trackId !== "undefined") {
            ...
            const clipIndex = originalTrack.findIndex(
              ({ id }) => id === clip.id
            );
